...
local parsers = {
  ...
  "json",
  "json5",
  -- "jsonc" deliberately absent: the treesitter `main` branch dropped it as a
  -- separate parser (it was in the LazyVim/master snapshot); install() warns
  -- "skipping unsupported language" if requested.
  "lua",
  "luadoc",
  "luap",
  "markdown",
